...
def prepare_segment_clip(
    ...
    if ffmpeg:
        ...
        return _prepare_clip_ffmpeg(video_path, start_sec, end_sec, output_path, height, ffmpeg)
...
def run_move_feedback_pipeline(
    ...
    try:
        ...
        result = call_gemini_move_feedback(ref_clip, user_clip, move_text, api_key=api_key, model_name=model_name)
